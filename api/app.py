...
from api.auth import READ, auth_enabled, require_scope
...
def create_app() -> FastAPI:
    ...
    # Every route requires at least READ (no-op when no token is configured).
    # Sensitive control routes add a stricter scope dependency in api/routes.py.
    app.include_router(api_router, dependencies=[Depends(require_scope(READ))])
